import{d as g,a2 as D,G as b,a3 as C,l as F,I as A,C as B,n as o,e as k,w as a,b as y,h as s,g as $,u as n,B as Y,j as M,al as E,a4 as P,a as u,a6 as U,k as V}from"./index.004badce.js";const j={class:"mt-2 xl:mt-0"},z=g({__name:"install",setup(N){const l=D(),d=b(()=>`${l.urlPrefix}${l.apiUrl}${E.installs}`),m=C({}),c=[{formatter:"responsiveCollapse",width:40,minWidth:30,hozAlign:"center",resizable:!0,headerSort:!1},{title:"\u65F6\u95F4",field:"updated_at",formatter(e){return P(e.getData().created_at,"YY-MM-DD HH:mm")},width:140},{title:"",width:280,field:"title",formatter(e){return u(`
