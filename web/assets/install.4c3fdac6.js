import{h as b,Y as D,D as C,Z as F,j as A,E as B,C as $,b as k,w as a,s as r,a as y,p as o,l as i,u,ac as Y,$ as E,d as m,a1 as M}from"./index.e83121be.js";const U=b({__name:"install",setup(P){const n=D(),d=C(()=>`${n.urlPrefix}${n.apiUrl}${Y.installs}`),c=F({}),f=[{formatter:"responsiveCollapse",width:40,minWidth:30,hozAlign:"center",resizable:!0,headerSort:!1},{title:"\u65F6\u95F4",field:"updated_at",formatter(e){return E(e.getData().created_at,"YY-MM-DD HH:mm")},width:140},{title:"",width:280,field:"title",formatter(e){return m(`
