import{h as b,Z as D,G as C,$ as F,j as A,H as B,C as k,l as a,b as $,w as s,a as y,q as o,m as i,u,ag as Y,a0 as M,d as m,a2 as E,_ as P}from"./index.178b6464.js";const U=b({__name:"install",setup(j){const n=D(),d=C(()=>`${n.urlPrefix}${n.apiUrl}${Y.installs}`),c=F({}),f=[{formatter:"responsiveCollapse",width:40,minWidth:30,hozAlign:"center",resizable:!0,headerSort:!1},{title:"\u65F6\u95F4",field:"updated_at",formatter(e){return M(e.getData().created_at,"YY-MM-DD HH:mm")},width:140},{title:"",width:280,field:"title",formatter(e){return m(`
